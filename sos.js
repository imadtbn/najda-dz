...
const serviceLocations = {
    ...
    civilDefense: [
        ...
        { name: "المديرية العامة للحماية المدنية (سيدي امحمد)", lat: 36.7615843, lng: 3.0488955, phone: "14 / 1021", address: "شارع أحمد غرمول، سيدي امحمد، الجزائر العاصمة" },
        { name: "وحدة الحماية المدنية - سوريكال (باب الزوار)", lat: 36.7385082, lng: 3.1854189, phone: "023 90 90 28", address: "حي سوريكال، باب الزوار، الجزائر" },
        { name: "الوحدة الوطنية للتدريب والتدخل (الدار البيضاء)", lat: 36.7224951, lng: 3.1999656, phone: "023 81 16 41", address: "الدار البيضاء، الجزائر العاصمة" },
        { name: "وحدة الحماية المدنية - الدويرة", lat: 36.6703608, lng: 2.9492977, phone: "023 32 17 55", address: "الطريق الوطني رقم 63، الدويرة، الجزائر" },
        { name: "وحدة الحماية المدنية - الحاميز", lat: 36.724384, lng: 3.200245, phone: "14", address: "الحاميز، الدار البيضاء، الجزائر" },
        { name: "وحدة الحماية المدنية - سيدي موسى", lat: 36.6101705, lng: 3.0879662, phone: "14", address: "سيدي موسى، ولاية الجزائر" },
        { name: "وحدة الحماية المدنية - بئر مراد رايس", lat: 36.7311, lng: 3.0506, phone: "021 56 14 14", address: "نهج الإخوة بوعدو، بئر مراد رايس" },
        { name: "وحدة الحماية المدنية - رويبة", lat: 36.7333, lng: 3.2833, phone: "021 81 14 14", address: "المنطقة الصناعية، الرويبة، الجزائر" },
        { name: "وحدة الحماية المدنية - زرالدة", lat: 36.7114, lng: 2.8425, phone: "021 32 14 14", address: "وسط مدينة زرالدة، الجزائر" },
        { name: "وحدة الحماية المدنية - الشراقة", lat: 36.7667, lng: 2.9333, phone: "021 36 14 14", address: "الشراقة، الجزائر العاصمة" },
        { name: "وحدة الحماية المدنية - الحراش", lat: 36.7233, lng: 3.1331, phone: "021 52 14 14", address: "وسط مدينة الحراش، الجزائر" },
        { name: "وحدة الحماية المدنية - الجزائر الوسطى", lat: 36.7694, lng: 3.0639, phone: "021 71 14 14", address: "ميناء الجزائر، ساحة الشهداء" }
